...
public class AlumnoView extends JPanel {
	...
	private void dibujar() {
		...
		gbl_panel.rowHeights = new int[] {20, 5, 20, 5};
		...
		gbc_inputApellido1.insets = new Insets(0, 0, 0, 5);
		gbc_inputApellido1.gridx = 0;
		...
		gbc_inputApellido2.gridx = 1;
		gbc_inputApellido2.gridy = 3;
