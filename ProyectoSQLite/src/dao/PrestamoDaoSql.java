...
public abstract class PrestamoDaoSql {
	...
	public static final String WHERE_KEY = " WHERE ALUMNO = UPPER(?) AND LIBRO = UPPER(?) AND FECHAPRESTAMO = ?";
	public static final String VALUES = " (ALUMNO, LIBRO, FECHAPRESTAMO, FECHADEVOLUCION, ESTADO) VALUES (?,?,?,?,?)";
	public static final String SET = " SET FECHADEVOLUCION = ?";
